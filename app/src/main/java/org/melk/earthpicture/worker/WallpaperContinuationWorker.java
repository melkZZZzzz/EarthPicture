...
public class WallpaperContinuationWorker extends EarthPictureWorker {

	static final protected String JobChainTag = "update_background";

	private Context context;

	public WallpaperContinuationWorker(@NonNull Context context, @NonNull WorkerParameters params ) {
	...
	public boolean doJob() {
		...
		earthPictureWorkManager.workManager
				...
				.then(EarthPictureWorkManager.WorkRequestSimpleBuilder(SetWallpaperWorker.class)
						.setInputData(workProperties)
						.addTag(JobChainTag)
						.build()
				)
